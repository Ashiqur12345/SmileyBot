...
public class OCRSpaceAsyncTask extends AsyncTask
{

	private static final String TAG = OCRSpaceAsyncTask.class.getName();
	...
	public OCRSpaceAsyncTask(Activity activity, String apiKey, boolean isOverlayRequired, String imageUrl, String language) {
